...
class HomeMobilePage {
  ...
  project(projectName) {
    return $(
      `//android.widget.TextView[@text="${projectName}"]/parent::android.view.View`
    );
  }
  ...
  get notifications() {
    return $(
      '//android.widget.TextView[@resource-id="android:id/title" and @text="Notifications"]/parent::android.widget.RelativeLayout/parent::android.widget.LinearLayout'
    );
  }

  get logoutCTA() {
    return $(
      '//android.widget.TextView[@resource-id="android:id/title" and @text="Log out"]/parent::android.widget.RelativeLayout/parent::android.widget.LinearLayout'
    );
  }
  ...
  /**
   * page objects in home page for mobile app
   */
